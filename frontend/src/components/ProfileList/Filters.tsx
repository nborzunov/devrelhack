...
export function ProfileFilters({ data }: { data: ProfileResponse | null }) {
            ...
            {data && (
                <Stack spacing={3}>
                    ...
                    <FormControl>
                        ...
                        <Box>
                            <Checkbox
                                isChecked={profileListFilter.hasEmail}
                                onChange={(e) =>
                                    createChangeHandler('email')(e.target.checked)
                                }
                            >
                                Show only users with emails
                            </Checkbox>
                        </Box>
                    </FormControl>
                </Stack>
